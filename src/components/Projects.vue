        ...
        <div class="flex justify-center">
         ...
         <!--text for 2nd project-->
          <div class="px-12 md:px-24 lg:pl-44 lg:pr-44 pb-12">
              ...
              <div class="flex flex-col lg:flex-row pt-2 gap-4 lg:gap-6">
                <p class="text-darkgray lg:w-1/2">
                  When I was studying in Hungary in my high school, during the final year each member of the class had to complete a project, which lasted for a year. During these 365 days I worked with the topic: Street art. I collected information about how graffiti and other forms of street art effected the sociate.
                </p>
              
                <p class="text-darkgray lg:w-1/2">
                  I talked with people, who are active part of this community or worked with organizations which create events for people who enjoy street art.
                  As a result of my one year project, I designed and painted my primary schools new logo on their entrance.                 </p>
              </div>
          </div>
      </div>
          ...
          <div class="px-12 md:px-24 lg:pl-44 lg:pr-44 pb-12">
              ...
              <div class="flex flex-col lg:flex-row pt-2 gap-4 lg:gap-6">
                <p class="text-darkgray lg:w-1/2">
                  ...
                  Our goal with this was to create a website from the ground to practice and use our skills that we were currently studying at our university. 
                  We started with the design.
                </p>
              
                <p class="text-darkgray lg:w-1/2">
                  By useing Adobe Xd we created the layout and the prototype which had the basic functionalities as well. After this we work on the codeing.
                  This project was only a little experimental thing, where our target was to use the skills and the knowladge that we would like to implement in the future projects with real clients.
                </p>
              </div>
          </div>
      </div>
         ...
         <!--text for 2nd project-->
          <div class="px-12 md:px-24 lg:pl-44 lg:pr-44 pb-12">
              ...
              <div class="flex flex-col lg:flex-row pt-2 gap-4 lg:gap-6">
                ...
                <p class="text-darkgray lg:w-1/2">
                  We used our own knowladge and templates to create the content behind this fictional mobile app. We also had to think and research about the colours and fonts that we wanted to use. 
                  After all the research we created an Adobe Xd prototype for the app.                </p>
              </div>
          </div>
      </div>
         ...
         <!--text for 2nd project-->
          <div class="px-12 md:px-24 lg:pl-44 lg:pr-44 pb-12">
              ...
              <div class="flex flex-col lg:flex-row pt-2 gap-4 lg:gap-6">
                ...
                <p class="text-darkgray lg:w-1/2">
                  We created a social media campaign and a plan for the next half year on SoMe site posts such as Facebook, Insagram and Tiktok. A short 1-3 minute video was also required, so we shooted a 45 second trailer video for the event, where we tell a little bit about the event it self and show videos and pictures of the city to get the peoples attention.               
                </p>
              </div>
          </div>
      </div>
